...
contract KRC20 is Context, IKRC20, Ownable {
    uint256 private constant _preMineSupply = 5000000 * 1e18; // refer tokenomics
    uint256 private constant _maxSupply = 350000000 * 1e18; // max limit
...
contract KUSToken is KRC20('KuSwap', 'KUS') {
    ...
    */
        ...
        external
    {
        ...
        require(block.timestamp <= expiry, "KUS::delegateBySig: signature expired");
